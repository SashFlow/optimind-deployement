...
const ReadOnlyEmpty: FC = () => (
	<div className="aui-thread-welcome-root mb-6 flex flex-col items-center px-4 py-10 text-center">
		<p className="text-muted-foreground text-sm">No messages yet.</p>
	</div>
);

/** Transcript / archival thread: same message UI as Thread, without composer. */
export const ReadOnlyThread: FC<{ components?: ThreadComponents }> = ({
	components = EMPTY_COMPONENTS,
}) => {
	return (
		<ThreadComponentsContext.Provider value={components}>
			...
			>
				<ThreadPrimitive.Viewport
					turnAnchor="top"
					data-slot="aui_thread-viewport"
					className="relative flex flex-1 flex-col overflow-x-auto overflow-y-scroll scroll-smooth [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden"
				>
					<div className="mx-auto flex w-full max-w-(--thread-max-width) flex-1 flex-col px-4 pt-4">
						...
						<ThreadPrimitive.ViewportFooter className="aui-thread-viewport-footer bg-background relative flex flex-col overflow-visible pb-4">
							<ThreadScrollToBottom />
						</ThreadPrimitive.ViewportFooter>
					</div>
				</ThreadPrimitive.Viewport>
